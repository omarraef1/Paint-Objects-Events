...
/**
 * This class is a test for your inheritance hierarchy. It has a hard-coded
 * Vector<PaintObject> and a method to draw all of those PaintObjects on a
 * Canvas that has been added as the center of a BorderPane. There are no Events
 * here. Just run this program after you finish the PaintObject inheritance
 * hierarchy.
 *
 * @author Rick Mercer
 */
public class TestPaintHierarchy extends Application {
	...
	private ArrayList<PaintObject> createVectorOfPaintObjects() {
		...
		PaintObject p = new Picture(new Point(600, 330), new Point(760, 450), "doge.jpeg");
